...
function CourseCard({ course }: { course: Course }) {
  ...
  const showProgress = enrolled && (course.progressPercent ?? 0) > 0;
        ...
        <div className="p-5 flex-1 flex flex-col">
          ...
          {enrolled ? (
            <Link
              ...
              className="block w-full text-center py-2 px-4 text-sm font-medium rounded-lg transition-colors bg-indigo-600 hover:bg-indigo-700 text-white"
            >
              {t('courses.continue')}
            </Link>
          ) : (
            <button
              ...
              className="block w-full text-center py-2 px-4 text-sm font-medium rounded-lg transition-colors bg-blue-600 hover:bg-blue-700 text-white"
            >
              {t('courses.enroll')}
            </button>
          )}
